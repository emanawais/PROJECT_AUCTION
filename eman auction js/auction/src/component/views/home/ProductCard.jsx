...
const ProductCard = ({ title, description, image, currentBid, endTime, bidCount }) => {
  return (
      ...
      <div className="p-4">
        ...
        <div className="flex justify-between items-center mb-3">
          <div>
            ...
            <p className="text-lg font-bold text-amber-600">${currentBid}</p>
          </div>
        ...
        <div className="w-full bg-gray-200 rounded-full h-2 mb-4">
          <div className="bg-amber-500 h-2 rounded-full" style={{width: `${Math.min(bidCount * 5, 100)}%`}} />
        </div>
